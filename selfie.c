...
// | 38 | mappings        | pointer to list of memory mappings // cambio_1
...
uint64_t mappings(uint64_t* context) { return (uint64_t) (context + 38); } // cambio_2
...
uint64_t MAPPINGENTRIES = 7; // cambio_3
